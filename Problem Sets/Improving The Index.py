...
def lookup(index, keyword):
    ...
    return None
index=[]
add_to_index(index,"hello hello","http://some.page/stuff.html")
add_to_index(index,'Good <a href="http://this.page/otherstuff.html">night</a>, sleep tight, go to bed and dream of Python',"http://other.page/morestuff.html")
add_to_index(index,"Wake up, wake up, the morning is here! It's time to go to work!","http://this.page/otherstuff.html")
print index
